...
### this scripts name
script_name = '01_build_model_v2.py'
...
### INPUT PARAMETERS ###
IFSS = 9.8 #=measurement from experiment
...
G_modeI = round(params['mechanical_parameters']['GI'], 4) #interface normal energy (dependant)
tII = round(params['mechanical_parameters']['tII,tIII']*IFSS, 4) #interface shear strength
tI = round(params['mechanical_parameters']['tI']*IFSS, 4) #interface normal strength (dependant)
