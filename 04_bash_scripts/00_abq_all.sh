...
##SBATCH --output=/home/vsenk/Droplet_Tests_FEA/01_neural_network_project/01_data/parameter_files/geometrical_samples/v2/%03a/slurm-%A_%a--%x.log  # Standard output and error log
