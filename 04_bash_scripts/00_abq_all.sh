...
#SBATCH --array=301-400%10 #submit job array with a maximum of 20 parallel jobs
...
#SBATCH --output=/home/vsenk/Droplet_Tests_FEA/01_neural_network_project/01_data/parameter_files/selected_param_samples/v2/%03a/slurm-%A_%a--%x.log  # Standard output and error log
